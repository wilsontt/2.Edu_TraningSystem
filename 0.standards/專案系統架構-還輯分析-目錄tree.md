...
```text
/
├── 0.standards/            # 專案規範與核心文件 (SDD 驅動)
│   ├── 1.綠地專案文件/      # 新功能規格 (Spec)、計畫 (Plan)、任務 (Tasks)
│   └── 2.棕地專案/          # 既有功能優化計畫 (如成績中心 T13)
├── 1.docs/                 # 開發記錄、架構分析、驗收報告、資料庫遷移指南
│   ├── 交付實作文件/        # 棕地迭代任務追溯
│   ├── 資料庫結構分析/      # 欄位定義與關聯說明
│   └── reviews/            # 開發與修復記錄
...
| `0.standards/專案系統架構分析.md` | 詳細的系統流程圖與資料流程 |
| `1.docs/資料庫結構分析/education_training_db_結構分析.md` | 資料表全欄位與關聯定義 |
| `1.docs/交付實作文件/README.md` | 棕地迭代 (2026-04~05) 的詳細任務清單 |
