...
> **狀態補註（2026-05-01）**：與「成績中心 — 部門績效表現、部門成員批次列印（list／individual 對齊個人預覽路徑）、展開成員成績列表欄寬與版面」相關之待測與修正項，已於程式與 [交付實作文件](../../1.docs/交付實作文件/README.md) 追溯完成。本檔其餘章節仍保留為規格與追蹤脈絡；文中標為選配或未來擴充者不在此補註範圍內。
