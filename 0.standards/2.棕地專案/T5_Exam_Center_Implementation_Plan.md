...
> **狀態補註（2026-05-02）**：產品已具備學員端考試中心、作答、交卷與計分之主流程（見 `backend/app/routers/exam.py`、`exam_center.py` 及前端考試路由）。下方 **T5.1～T5.5 checklist 為早期規劃文字**，未逐條與現況核對，**不得**依未勾選判斷「考試中心未上線」。若需精準對照功能完成度，請以交付實作文件與程式為準。
