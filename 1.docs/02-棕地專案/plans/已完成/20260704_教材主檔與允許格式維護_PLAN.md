...
| [20260612_系統備援_NAS儲存與排程備份_PLAN.md](./20260612_系統備援_NAS儲存與排程備份_PLAN.md) | NAS 儲存層 |
...
- [x] §5.8 驗收條件手動測試（**產品驗收 2026-07-14**：後台與 NAS）
...
| 修改 | `1.docs/02-棕地專案/plans/已完成/20260617_教材上傳列管與教材庫_PLAN.md` | Phase E |
